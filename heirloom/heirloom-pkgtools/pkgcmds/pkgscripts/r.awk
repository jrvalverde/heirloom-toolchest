...
#
# from OpenSolaris r.awk	1.6	06/02/27 SMI
#
# Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
#
# Sccsid @(#)r.awk.in	1.3 (gritter) 2/24/07
#
...
do
	...
	then
		...
		/home/jr/contrib/heirloom/usr/sadm/install/scripts/cmdexec /home/jr/contrib/heirloom/usr/5bin/awk remove $savepath $dest ||
			error=yes
	else
		[ -r $dest ] && echo "$dest"
		rm -f $dest || error=yes
